                ...
                <div id='portfolio' class="tab-pane fade">
                  <div class="body-content">
                    ...
                    <ul id='portfolio-grid' class="list-unstyled grid-portfolio">
                      ...
                      <li class="mix vid">
                        <div class="item-portfolio">
                          <a href="https://www.youtube.com/watch?v=2MNCUDoxmUQ" target="_blank" class="preview-portfolio">
                      ...
                      <li class="mix vid">
                        <div class="item-portfolio">
                          <a href="https://www.youtube.com/watch?v=rKIwacjPVrE" target="_blank" class="preview-portfolio">
                            <div class="mask"><div class="icn-center"><i class="fa fa-play "></i></div></div>
                            <img src="img/portfolio/default.jpg" alt="" class="img-responsive"/>
                          </a>
                      ...
                      <li class="mix vid design">
                        <div class="item-portfolio">
                          <a href="http://webdoc.mmi-angouleme.fr/?webdocu=le-guide-des-internet" target="_blank" class="preview-portfolio">
                            <div class="mask"><div class="icn-center"><i class="fa fa-link "></i></div></div>
                            <img src="img/portfolio/default.jpg" alt="" class="img-responsive"/>
                          </a>
                      ...
                      <li class="mix vid">
                        <div class="item-portfolio">
                          <a href="https://www.youtube.com/watch?v=-zE4y_aB1zg" target="_blank" class="preview-portfolio">
                            <div class="mask"><div class="icn-center"><i class="fa fa-play "></i></div></div>
                            <img src="img/portfolio/default.jpg" alt="" class="img-responsive"/>
                          </a>
                      ...
                      <li class="mix vid dev">
                        <div class="item-portfolio">
                          <a href="https://www.youtube.com/watch?v=rcWffYFqxe8" target="_blank" class="preview-portfolio">
                            <div class="mask"><div class="icn-center"><i class="fa fa-play "></i></div></div>
                            <img src="img/portfolio/default.jpg" alt="" class="img-responsive"/>
                          </a>
                      ...
                      <li class="mix vid">
                        <div class="item-portfolio">
                          <a href="https://www.youtube.com/watch?v=uTnajk9OT-4" target="_blank" class="preview-portfolio">
                            <div class="mask"><div class="icn-center"><i class="fa fa-play "></i></div></div>
                            <img src="img/portfolio/default.jpg" alt="" class="img-responsive"/>
                          </a>
                      ...
                      <li class="mix design">
                        <div class="item-portfolio">
                          <a href="assets/pdf/FAHRENHEIT.pdf" target="_blank" class="preview-portfolio">
